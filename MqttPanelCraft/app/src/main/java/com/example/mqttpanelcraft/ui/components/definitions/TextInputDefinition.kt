...
object TextInputDefinition : IComponentDefinition {
    ...
    override fun createView(context: Context, isEditMode: Boolean): View {
        ...
        val et = EditText(context).apply {
            ...
            // If in Run Mode, maybe enable input? But "ComponentContainer" might handle touch event.
    ...
    override fun onUpdateView(view: View, data: ComponentData) {
        ...
        // Mode switch helper
        // Since view is reused, we might need to toggle focusability dynamically if mode changes (Run <-> Edit).
