...
object LevelIndicatorDefinition : IComponentDefinition {
    ...
    override val iconResId = android.R.drawable.ic_lock_power_off // Placeholder icon for Level? or Sort?
    override val group = "SENSOR" // Sensor? Display? User said "Sensor contains temperature and LED etc". Level is similar.
